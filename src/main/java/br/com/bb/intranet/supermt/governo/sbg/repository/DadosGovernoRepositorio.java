...
public class DadosGovernoRepositorio implements Serializable {
    ...
    public DadosGoverno porId(Long id) {
        return manager.find(DadosGoverno.class, id);
    }

    public void adicionar(DadosGoverno usuario) {
        this.manager.persist(usuario);
    }

    public void atualizar(DadosGoverno usuario) {
    ...
    public void remover(DadosGoverno usuario) {
