...
public class IfdmRepositorio implements Serializable {
    ...
    public Ifdm porId(Long id) {
        return manager.find(Ifdm.class, id);
    }

    public void adicionar(Ifdm usuario) {
        this.manager.persist(usuario);
    }

    public void atualizar(Ifdm usuario) {
    ...
    public void remover(Ifdm usuario) {
